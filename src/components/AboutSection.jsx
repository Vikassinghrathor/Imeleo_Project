      ...
      <div className="flex flex-wrap gap-10 items-center mt-12 w-full max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[475px] max-md:max-w-full">
          <div className="flex flex-col w-full max-md:max-w-full">
            <div className="flex flex-col w-full max-md:max-w-full">
              <div className="flex flex-col w-full max-md:max-w-full">
                <div className="w-full text-5xl font-semibold text-blue-800 max-md:max-w-full max-md:text-4xl">
                  <span className="text-gray-700">We Are Increasing </span>
                  Business<span className="text-gray-700"> Success With</span>
                   Technology
                </div>
                <div className="mt-5 text-lg text-gray-600 max-md:max-w-full">
            ...
            <div className="flex flex-col items-start mt-8 max-w-full text-3xl font-semibold text-gray-800 w-[363px]">
              <div className="flex gap-5 items-center">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/44c009b64e188ba545de851e3e682b3e552585275484dae6a9c78f32cd5ae477?placeholderIfAbsent=true&apiKey=ddf789af42b44eaea963851b07583965"
              ...
              <div className="flex gap-5 items-center mt-8">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/3ff31ff47eaf27b0ab2b8e4c6ed1c45e2956fd00e7708c676666e218e2f5911a?placeholderIfAbsent=true&apiKey=ddf789af42b44eaea963851b07583965"
                  className="object-contain shrink-0 self-stretch my-auto w-7 aspect-[0.87]"
                />
                <div className="self-stretch my-auto w-[233px]">
                  Strategic Growth
                </div>
              </div>
              <div className="flex gap-5 items-start self-stretch mt-8 w-full">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/62d8122eb1927ee65c1ef878b7d0581f71d77f47f7db7b251dcfa1001dc21c31?placeholderIfAbsent=true&apiKey=ddf789af42b44eaea963851b07583965"
                  className="object-contain shrink-0 w-7 aspect-[0.87]"
                />
                <div className="w-[317px]">Enhanced Performance</div>
              </div>
            </div>
          </div>
          <div className="flex gap-2.5 justify-center items-center self-start px-9 py-5 mt-12 text-base font-bold text-center text-white bg-blue-800 rounded-lg max-md:px-5 max-md:mt-10">
